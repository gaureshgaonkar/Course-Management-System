    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3>Student List</h3>
                <a href="studentact.php?action=form" class="btn btn-primary">
                    + Add Student
                </a>
            </div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <?php foreach ($students as $s): ?>
                            <tr>
                                ...
                                <td><?= $s['class'] ?></td>
                                <td>
                                    <a href="studentact.php?action=form&id=<?= $s['student_id'] ?>" 
                                       class="btn btn-sm btn-warning">
                                       Edit
                                    </a>

                                    <a href="studentact.php?action=delete&id=<?= $s['student_id'] ?>" 
