...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="mb-4">
                <h3>
                    <?= isset($student['id']) ? 'Edit Student' : 'Add Student' ?>
                </h3>
            </div>

            <div class="card card-custom p-4">
                <form method="post" action="studentact.php?action=save">
...
function goBack() {
    if (window.history.length > 1) {
        ...
        window.location.href = "studentact.php";
    }
}
</script>
