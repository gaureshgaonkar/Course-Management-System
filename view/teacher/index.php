    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3>Teacher List</h3>
                <a href="teacheract.php?action=form" class="btn btn-primary">
                    + Add Teacher
                </a>
            </div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <?php foreach ($teachers as $t): ?>
                            <tr>
                                ...
                                <td><?= $t['mobileno'] ?></td>
                                <td>
                                    <a href="teacheract.php?action=form&id=<?= $t['teacher_id'] ?>" 
                                       class="btn btn-sm btn-warning">
                                       Edit
                                    </a>

                                    <a href="teacheract.php?action=delete&id=<?= $t['teacher_id'] ?>" 
